...
class MenuModel extends Model implements ModelInterface
{
    ...
    protected $allowedFields    = [
        'menu_name',
        'menu_derivative_controller',
        'menu_is_active',
        'menu_created_date',
        'menu_last_modified_date',
        'menu_created_by',
        'menu_last_modified_by',
        'fk_status_id'
    ];
    ...
    protected $createdField  = 'menu_created_date';
    protected $updatedField  = 'menu_last_modified_date';

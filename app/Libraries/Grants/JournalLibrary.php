...
class JournalLibrary extends GrantsLibrary implements \App\Interfaces\LibraryInterface
{
    ...
    function getOfficeDataFromJournal($journal_id)
    {
        $builder = $this->read_db->table("office");
        $builder->select(array('office_id', 'office_name', 'journal_id', 'journal_month', 'fk_account_system_id'));
        $builder->join('journal', 'journal.fk_office_id=office.office_id');
        $builder->where(array('journal_id' => $journal_id));
    ...
    function journalRecords($office_id, $transacting_month, $project_allocation_ids = [], $office_bank_id = 0)
    {
    ...
    function getVoucherSpread($all_voucher_details, $current_voucher_id)
    {
    ...
    function getAllOfficeMonthVouchers($office_id, $transacting_month, $project_allocation_ids = [], $office_bank_id = 0)
    {
        ...
        if (
            ...
            $builder->select(array('voucher_type_abbrev', 'voucher_type_name'));
            $builder->select(array('voucher_type_account_code'));
            $builder->select(array('voucher_type_effect_code'));
            $builder->select(array(
            ...
            $builder->where(array('voucher_date >=' => $month_start_date, 'voucher_date <=' => $month_end_date, 'fk_office_id' => $office_id));
    ...
    function monthOpeningBankCashBalance($office_id, $transacting_month, $office_bank_id = 0)
    {
    ...
    function getOfficeBankProjectAllocation($office_bank_id)
    {
    ...
    public function getCashIncomeOrExpenseToDate($office_id, $transacting_month, $cash_account, $transaction_effect, $office_bank_id = 0, $office_cash_id = 0)
    {
        ...
        if ($office_cash_id) {
            $builder->where(array('fk_office_cash_id' => $office_cash_id, 'fk_office_id' => $office_id));
        }
        ...
        */
        ...
        if (($cash_account == 'cash' && $transaction_effect == 'income') || ($cash_account == 'bank' && $transaction_effect == 'bank_contra')) {
            $builder->groupStart();
            $builder->where(array('voucher_type_account_code' => 'cash', 'voucher_type_effect_code' => 'income'));

            $builder->orGroupStart();
            $builder->where(array('voucher_type_account_code' => 'bank', 'voucher_type_effect_code' => 'bank_contra'));
            $builder->groupEnd();
            ...
            $builder->groupStart();
            $builder->where(array('voucher_type_account_code' => 'cash', 'voucher_type_effect_code' => 'expense'));

            $builder->orGroupStart();
            $builder->where(array('voucher_type_account_code' => 'cash', 'voucher_type_effect_code' => 'cash_contra'));
            $builder->groupEnd();
            ...
            $builder->groupStart();
            $builder->where(array('voucher_type_account_code' => 'bank', 'voucher_type_effect_code' => 'income'));
            ...
            $builder->groupStart();
            $builder->where(array('voucher_type_account_code' => 'bank', 'voucher_type_effect_code' => 'expense'));
    ...
    private function systemOpeningCashBalance($office_id, $office_bank_id = 0)
    {
        ...
        if ($office_bank_id > 0) {
            $builder->where(array('opening_cash_balance.fk_office_bank_id' => $office_bank_id));
        }

        $builder->selectSum('opening_cash_balance_amount');
        $builder->groupBy('office_cash_id');
        $builder->select(array('office_cash_name', 'fk_office_cash_id'));
        ...
        $builder->select(array('office_cash_id', 'office_cash_name'));
        ...
        $office_cash_obj = $builder->getWhere(array('office_id' => $office_id));
    ...
    private function systemOpeningBankBalance($office_id, $office_bank_id = 0)
    {
        ...
        $builder->select(array('opening_bank_balance_amount', 'office_bank_id', 'office_bank_name'));
        ...
        $opening_bank_balance_obj = $builder->getWhere(array('office_bank.fk_office_id' => $office_id, 'system_opening_balance.fk_office_id' => $office_id));
        ...
        $office_banks_obj = $builder->getWhere(array('fk_office_id' => $office_id));
    ...
    function journalNavigation($office_id, $transacting_month)
    {
    ...
    function financialAccounts($office_id, $transacting_month)
    {
        return [
    ...
    function monthOfficeUsedExpenseAccounts($office_id, $transacting_month)
    {
        ...
        $builder = $this->read_db->table("voucher_detail");
        $builder->select(array('fk_expense_account_id expense_account_id'));
        $builder->where(array(
    ...
    private function expenseAccounts($office_id)
    {
        ...
        $builder->select(array('expense_account_id', 'expense_account_code'));
    ...
    function monthOfficeUsedIncomeAccounts($office_id, $transacting_month)
    {
        ...
        $builder = $this->read_db->table("voucher_detail");
        $builder->select(array('fk_income_account_id income_account_id'));
        $builder->where(array(
            'voucher_date >=' => $start_date,
            'voucher_date <=' => $end_date,
    ...
    private function incomeAccounts($office_id)
    {
        ...
        $builder->select(array('income_account_id', 'income_account_code'));
        $builder->join('account_system', 'account_system.account_system_id=income_account.fk_account_system_id');
        $builder->join('office', 'office.fk_account_system_id=account_system.account_system_id');
        $builder->where(array('office_id' => $office_id));
        $accounts = $builder->get()->getResultArray();
    ...
    function journalSpread($office_id, $spread, $transacting_month,$account_type = 'bank',$transaction_effect = 'income'){    
        $financial_accounts = $this->financialAccounts($office_id, $transacting_month);

    ...
    function officeHiddenBankVoucherTypes($office_id){
      ...
      function checkIfHiddenBankIncomeExpenseVoucherTypePresent(){
        ...
        if($voucher_type->getNumRows() < 3){
          ...
          $hidden_bank_income_expense_voucher_type_present = $this->createHiddenVoucherTypes();
        }else{
      ...
      function createHiddenVoucherTypes(){
        //return true;
      ...
      $data['chequecancellation']['voucher_type_name'] = 'Voided Cheque';
      ...
      $data['chequecancellation']['fk_account_system_id'] = $this->session->user_account_system_id;

		...
		<div class="login-form">
			...
			<div class="login-content">
				...
				<div class="form-login-error">
					...
					<p><?= get_phrase('invalid_login_reasons', '1) If active in System: Please enter correct email and password! 2) \n If Account is New: Please Contact Admin to activate your account!'); ?>
					</p>

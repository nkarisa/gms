...
<?php
 ...
 if(!$multiple_offices_report && count($office_banks) > 1){?>
...
<?php } ?>
        ...
        <table class="table table-striped" id="tbl_list_statements">
            ...
            <tbody>
                <?php
                    if((isset($bank_statements_uploads))){ 
                    foreach($bank_statements_uploads as $bank_statements_upload){
                        ...
                        <td>
                            <?php 
                                if(count($office_banks) == 1){?>
                                    <a href="#" class="fa fa-trash-o delete_statement" id="<?=$bank_statements_upload['attachment_id'];?>" data-file_name="<?=$bank_statements_upload['attachment_name'];?>" data-file_path="<?=$bank_statements_upload['attachment_url'];?>"></a>
                            <?php }?>
                        </td>

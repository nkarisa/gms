...
CREATE TABLE `account_system` (
  ...
  `account_system_is_active` int NOT NULL DEFAULT '1',
...
CREATE TABLE `account_system_language` (
  ...
  CONSTRAINT `account_system_language_ibfk_1` FOREIGN KEY (`fk_account_system_id`) REFERENCES `account_system` (`account_system_id`),
  CONSTRAINT `account_system_language_ibfk_2` FOREIGN KEY (`fk_language_id`) REFERENCES `language` (`language_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `account_system_setting` (
  ...
  `account_system_setting_accounts` json NOT NULL,
...
CREATE TABLE `approval_flow` (
  ...
  KEY `fk_approve_item_id` (`fk_approve_item_id`),
  KEY `fk_account_system_id` (`fk_account_system_id`),
  CONSTRAINT `approval_flow_ibfk_5` FOREIGN KEY (`fk_approve_item_id`) REFERENCES `approve_item` (`approve_item_id`),
  CONSTRAINT `approval_flow_ibfk_6` FOREIGN KEY (`fk_account_system_id`) REFERENCES `account_system` (`account_system_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `approve_item` (
  ...
  `approve_item_is_active` int NOT NULL,
...
CREATE TABLE `attachment` (
  ...
  `attachment_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `attachment_type` (
  ...
  `attachment_type_name` varchar(100) NOT NULL,
  `attachment_type_track_number` varchar(100) NOT NULL,
  `fk_approve_item_id` int NOT NULL,
  `fk_account_system_id` int NOT NULL,
...
CREATE TABLE `bank` (
  ...
  PRIMARY KEY (`bank_id`),
  KEY `fk_account_system_id` (`fk_account_system_id`),
  CONSTRAINT `bank_ibfk_1` FOREIGN KEY (`fk_account_system_id`) REFERENCES `account_system` (`account_system_id`)
...
CREATE TABLE `budget_item` (
  ...
  `budget_item_description` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  CONSTRAINT `fk_budget_detail_budget_id` FOREIGN KEY (`fk_budget_id`) REFERENCES `budget` (`budget_id`) ON UPDATE CASCADE,
...
CREATE TABLE `budget_limit` (
  ...
  CONSTRAINT `budget_limit_ibfk_5` FOREIGN KEY (`fk_budget_id`) REFERENCES `budget` (`budget_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `budget_review_count` (
  ...
  `budget_review_count_last_modified_by` int NOT NULL,
  `fk_status_id` int NOT NULL,
  `fk_approval_id` int NOT NULL,
...
CREATE TABLE `cancel_cheque` (
  ...
  `cancel_cheque_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `cancel_cheque_track_number` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `other_reason` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `cheque_book` (
  ...
  `cheque_book_is_used` int DEFAULT NULL,
...
CREATE TABLE `cheque_book_reset` (
  ...
  `cheque_book_reset_name` longtext NOT NULL,
  `cheque_book_reset_track_number` varchar(100) NOT NULL,
  `fk_office_bank_id` int NOT NULL,
...
CREATE TABLE `cheque_injection` (
  ...
  `fk_office_bank_id` int NOT NULL,
  `cheque_injection_number` int NOT NULL,
  `cheque_injection_is_active` int DEFAULT '1',
  `fk_item_reason_id` int NOT NULL,
...
CREATE TABLE `context_center` (
  ...
  CONSTRAINT `context_center_ibfk_1` FOREIGN KEY (`fk_office_id`) REFERENCES `office` (`office_id`),
  ...
  CONSTRAINT `context_center_ibfk_3` FOREIGN KEY (`fk_context_cluster_id`) REFERENCES `context_cluster` (`context_cluster_id`)
...
CREATE TABLE `context_cluster` (
  ...
  CONSTRAINT `context_cluster_ibfk_1` FOREIGN KEY (`fk_office_id`) REFERENCES `office` (`office_id`),
  ...
  CONSTRAINT `context_cluster_ibfk_3` FOREIGN KEY (`fk_context_cohort_id`) REFERENCES `context_cohort` (`context_cohort_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
...
CREATE TABLE `context_cohort` (
  ...
  CONSTRAINT `context_cohort_ibfk_1` FOREIGN KEY (`fk_office_id`) REFERENCES `office` (`office_id`),
  ...
  CONSTRAINT `context_cohort_ibfk_3` FOREIGN KEY (`fk_context_country_id`) REFERENCES `context_country` (`context_country_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
...
CREATE TABLE `context_country` (
  ...
  CONSTRAINT `context_country_ibfk_1` FOREIGN KEY (`fk_office_id`) REFERENCES `office` (`office_id`),
...
CREATE TABLE `context_country_user` (
  ...
  `fk_user_id` int NOT NULL,
  `fk_designation_id` int NOT NULL,
  `context_country_user_is_active` int NOT NULL DEFAULT '1',
  `context_country_user_created_by` int DEFAULT NULL,
...
CREATE TABLE `context_region` (
  ...
  KEY `fk_context_definition_id` (`fk_context_definition_id`),
  KEY `fk_context_global_id` (`fk_context_global_id`),
  CONSTRAINT `context_region_ibfk_1` FOREIGN KEY (`fk_office_id`) REFERENCES `office` (`office_id`),
...
CREATE TABLE `country_currency` (
  ...
  KEY `fk_account_system_id` (`fk_account_system_id`),
  CONSTRAINT `country_currency_ibfk_1` FOREIGN KEY (`fk_account_system_id`) REFERENCES `account_system` (`account_system_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `currency_conversion` (
  ...
  `currency_conversion_created_by` int NOT NULL,
  `currency_conversion_last_modified_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `currency_conversion_last_modified_by` int NOT NULL,
  `fk_approval_id` int DEFAULT NULL,
  `fk_status_id` int DEFAULT NULL,
...
CREATE TABLE `expense_account` (
  ...
  CONSTRAINT `fk_expense_account_income_account` FOREIGN KEY (`fk_income_account_id`) REFERENCES `income_account` (`income_account_id`)
...
CREATE TABLE `financial_report` (
  ...
  CONSTRAINT `financial_report_ibfk_3` FOREIGN KEY (`fk_status_id`) REFERENCES `status` (`status_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `funds_transfer` (
  ...
  `funds_transfer_last_modified_date` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE CURRENT_TIMESTAMP,
  `fk_approval_id` int DEFAULT NULL,
  ...
  CONSTRAINT `funds_transfer_ibfk_5` FOREIGN KEY (`fk_office_id`) REFERENCES `office` (`office_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
CREATE TABLE `language_phrase` (
  ...
  `phrase` longtext,
  `phrase_translation` longtext,
  `fk_language_id` int DEFAULT NULL,
  `fk_account_system_id` int DEFAULT NULL,
  `language_phrase_data` json DEFAULT NULL,
  ...
  CONSTRAINT `fk_account_system_id` FOREIGN KEY (`fk_account_system_id`) REFERENCES `account_system` (`account_system_id`),
...
CREATE TABLE `medical_claim` (
  ...
  CONSTRAINT `medical_claim_ibfk_4` FOREIGN KEY (`fk_medical_claim_type_id`) REFERENCES `medical_claim_type` (`medical_claim_type_id`),
...
CREATE TABLE `medical_claim_admin_setting` (
  ...
  `medical_claim_admin_setting_name` varchar(100) NOT NULL,
  `medical_claim_admin_setting_track_number` varchar(100) NOT NULL,
...
CREATE TABLE `office_bank` (
  ...
  `office_bank_chequebook_size` int NOT NULL DEFAULT '100',
...
CREATE TABLE `opening_bank_balance` (
  ...
  `opening_bank_balance_amount` decimal(50,2) NOT NULL,
  `fk_office_bank_id` int NOT NULL,
  ...
  `opening_bank_balance_is_reconciled` int DEFAULT '0',
  `fk_status_id` int NOT NULL,
  `fk_approval_id` int NOT NULL,
...
CREATE TABLE `opening_fund_balance` (
  ...
  `opening_fund_balance_amount` decimal(50,2) DEFAULT NULL,
  ...
  `opening_fund_balance_opening` decimal(50,2) DEFAULT NULL,
  `opening_fund_balance_income` decimal(50,2) DEFAULT NULL,
  `opening_fund_balance_expense` decimal(50,2) DEFAULT NULL,
  `fk_approval_id` int DEFAULT NULL,
  `fk_status_id` int DEFAULT NULL,
...
CREATE TABLE `opening_outstanding_cheque` (
  ...
  `opening_outstanding_cheque_cleared_date` date DEFAULT '0000-00-00',
...
CREATE TABLE `permission_template` (
  ...
  `permission_template_created_date` date DEFAULT NULL,
  `permission_template_created_by` int DEFAULT NULL,
  `permission_template_last_modified_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `permission_template_last_modified_by` int DEFAULT NULL,
  `fk_status_id` int DEFAULT NULL,
  `fk_approval_id` int DEFAULT NULL,
...
CREATE TABLE `project` (
  ...
  `project_last_modified_by` int NOT NULL,
...
CREATE TABLE `reimbursement_app_type` (
  ...
  `reimbursement_app_type_name` varchar(100) CHARACTER SET ascii COLLATE ascii_general_ci DEFAULT NULL,
  `reimbursement_app_type_track_number` varchar(100) CHARACTER SET ascii COLLATE ascii_general_ci DEFAULT NULL,
  `fk_account_system_id` int NOT NULL,
...
CREATE TABLE `reimbursement_claim` (
  ...
  `fk_approval_id` int DEFAULT NULL,
  `fk_status_id` int DEFAULT NULL,
  `reimbursement_claim_approvers` json DEFAULT NULL,
...
CREATE TABLE `role_group_association` (
  ...
  `role_group_association_is_active` int NOT NULL DEFAULT '1',
  `role_group_association_created_date` date NOT NULL,
  `role_group_association_created_by` int NOT NULL,
  `role_group_association_last_modified_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `role_group_association_last_modified_by` int NOT NULL,
  `fk_status_id` int NOT NULL,
  `fk_approval_id` int NOT NULL,
...
CREATE TABLE `role_permission` (
  ...
  `role_permission_created_by` int NOT NULL,
  `role_permission_last_modified_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `role_permission_last_modified_by` int NOT NULL,
  PRIMARY KEY (`role_permission_id`),
  KEY `fk_role_id` (`fk_role_id`),
  KEY `fk_permission_id` (`fk_permission_id`),
  CONSTRAINT `role_permission_ibfk_6` FOREIGN KEY (`fk_permission_id`) REFERENCES `permission` (`permission_id`),
  CONSTRAINT `role_permission_ibfk_7` FOREIGN KEY (`fk_role_id`) REFERENCES `role` (`role_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `role_user` (
  ...
  `role_user_track_number` varchar(100) NOT NULL,
  `role_user_name` longtext NOT NULL,
  `fk_role_id` int NOT NULL,
  `fk_user_id` int NOT NULL,
...
CREATE TABLE `scheduled_task` (
  ...
  `scheduled_task_name` varchar(100) NOT NULL,
  `scheduled_task_track_number` varchar(100) NOT NULL,
  `scheduled_task_minute` varchar(50) NOT NULL,
  `scheduled_task_hour` varchar(50) NOT NULL,
  `scheduled_task_day_of_month` varchar(50) NOT NULL,
  `scheduled_task_month` varchar(50) NOT NULL,
  `scheduled_task_day_of_week` varchar(50) NOT NULL,
  `scheduled_task_is_active` int NOT NULL DEFAULT '1',
  `scheduled_task_last_run` varchar(50) DEFAULT NULL,
  `scheduled_task_next_run` varchar(50) DEFAULT NULL,
...
CREATE TABLE `status` (
  ...
  CONSTRAINT `status_ibfk_3` FOREIGN KEY (`fk_approval_flow_id`) REFERENCES `approval_flow` (`approval_flow_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `status_role` (
  ...
  CONSTRAINT `status_role_ibfk_5` FOREIGN KEY (`status_role_status_id`) REFERENCES `status` (`status_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `untranslated_phrase` (
  ...
  `phrase_translation` longtext,
  `untranslated_phrase_created_date` datetime NOT NULL,
  `untranslated_phrase_created_by` int NOT NULL,
  `untranslated_phrase_last_modified_by` int NOT NULL,
  `untranslated_phrase_last_modified_date` datetime DEFAULT NULL,
...
CREATE TABLE `user` (
  ...
  `user_is_switchable` int DEFAULT '1',
  ...
  KEY `fk_country_currency_id` (`fk_country_currency_id`),
  KEY `fk_account_system_id` (`fk_account_system_id`),
  KEY `fk_unique_identifier_id` (`fk_unique_identifier_id`),
  ...
  CONSTRAINT `user_ibfk_6` FOREIGN KEY (`fk_unique_identifier_id`) REFERENCES `unique_identifier` (`unique_identifier_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `user_account_activation` (
  ...
  `user_account_activation_last_modified_date` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  ...
  `user_account_activation_approvers` json DEFAULT NULL,
...
CREATE TABLE `voucher` (
  ...
  `voucher_vendor` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `voucher_vendor_address` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `voucher_description` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  CONSTRAINT `voucher_ibfk_4` FOREIGN KEY (`fk_cheque_book_id`) REFERENCES `cheque_book` (`cheque_book_id`),
  CONSTRAINT `voucher_ibfk_5` FOREIGN KEY (`fk_cheque_book_id`) REFERENCES `cheque_book` (`cheque_book_id`)
...
CREATE TABLE `voucher_detail` (
  ...
  `fk_voucher_id` int DEFAULT NULL,
  `voucher_detail_description` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  `voucher_detail_last_modified_by` varchar(100) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,

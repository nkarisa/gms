...
---
### 2. Configure New Relic INI file ###
...
if [ ! -f "$TEMPLATE_FILE" ]; then
    echo "Warning: Template file '$TEMPLATE_FILE' not found! Skipping New Relic configuration."
    # The original script exited with 0 here, so we continue this behavior.
    exit 0 
fi
